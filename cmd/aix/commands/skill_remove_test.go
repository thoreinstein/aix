...
func TestSkillRemoveCommand_Metadata(t *testing.T) {
	if skillRemoveCmd.Use != "remove <name>" {
		t.Errorf("Use = %q, want %q", skillRemoveCmd.Use, "remove <name>")
	}
