...
func TestOutputMCPShowJSON(t *testing.T) {
	...
	// Test JSON output
	err := outputShowJSON("github", details, differences)
	if err != nil {
...
func TestShowOutputStructure(t *testing.T) {
	// Test that showOutput can be marshaled correctly
	output := showOutput{
		Name: "github",
	...
	var unmarshaled showOutput
	if err := json.Unmarshal(data, &unmarshaled); err != nil {
		t.Fatalf("failed to unmarshal showOutput: %v", err)
	}
