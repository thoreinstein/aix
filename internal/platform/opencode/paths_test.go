...
func TestOpenCodePaths_SkillDir(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want:        filepath.Join("/my/project", "skill"),
		},
		{
...
func TestOpenCodePaths_AgentDir(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			scope:       ScopeUser,
			projectRoot: "",
			want:        filepath.Join(home, ".config", "opencode", "agent"),
		},
		{
			name:        "project scope",
			scope:       ScopeProject,
			projectRoot: "/my/project",
			want:        filepath.Join("/my/project", "agent"),
		},
		{
			name:        "project scope empty root",
			scope:       ScopeProject,
...
func TestOpenCodePaths_SkillPath(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			projectRoot: "",
			skillName:   "debug",
			want:        filepath.Join(home, ".config", "opencode", "skill", "debug", "SKILL.md"),
		},
		{
			...
			projectRoot: "/my/project",
			skillName:   "refactor",
			want:        filepath.Join("/my/project", "skill", "refactor", "SKILL.md"),
		},
		{
...
func TestOpenCodePaths_AgentPath(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			projectRoot: "/my/project",
			agentName:   "planner",
			want:        filepath.Join("/my/project", "agent", "planner.md"),
		},
		{
			name:        "empty name returns empty",
			scope:       ScopeUser,
